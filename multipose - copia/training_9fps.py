...
detections = np.array(['apuntando_derecha'])
number_of_train_videos = 5
number_of_frames_per_video = 9
...
print(len(apuntando_derecha[0]))
np.save("./"+DATA_PATH+"/apuntando_derecha/apuntando_derecha_t", np.array(apuntando_derecha[0]))
#np.save("./"+DATA_PATH+"/apuntando_izquierda/apuntando_izquierda_t", np.array(apuntando_izquierda[0]))
