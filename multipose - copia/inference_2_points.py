...
lstm_model.add(LSTM(128, return_sequences=True, activation='relu', input_shape=(15,24)))
lstm_model.add(LSTM(64, return_sequences=False, activation='relu'))
lstm_model.add(Dense(64, activation='relu'))
lstm_model.add(Dense(32, activation='relu'))
lstm_model.add(Dense(6, activation='softmax'))

lstm_model.load_weights("./modelo_dos_val_0.1.h5")
...
def draw_keypoints(frame, keypoints, confidence_threshold):
    ...
    for kp in shaped:
        ...
        if kp_conf > confidence_threshold:
            ...
            filtered_keypoints.append([ky,kx]);
        else:
            filtered_keypoints.append(np.zeros(2))
