...
#caminando_derecha, caminando_izquierda
detections = np.array(['caminando_izquierda'])
number_of_train_videos = 20
...
print(len(caminando_izquierda[0]))
#np.save("./"+DATA_PATH+"/caminando_derecha/caminando_derecha_test", np.array(caminando_derecha[0]))
np.save("./"+DATA_PATH+"/caminando_izquierda/caminando_izquierda_test", np.array(caminando_izquierda[0]))
# todos los 80 del 4 85-90
